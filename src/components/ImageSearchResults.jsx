...
const ImageSearchResults = ({ results, lastResultElementRef }) => {
    console.log(results);
                ...
                {results.items?.map((result, index) => (
                    <div key={result.link} className="mb-8">
                        <div className="group flex flex-col">
                            <Link
                                className="h-60 group-hover:shadow-xl object-contain transition-shadow duration-300 text-sm truncate"
